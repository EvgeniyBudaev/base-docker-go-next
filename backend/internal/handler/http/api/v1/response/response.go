...
import (
	"errors"
	errorDomain "github.com/EvgeniyBudaev/base-docker-go-next/backend/internal/handler/http/api/v1/error"
	"github.com/EvgeniyBudaev/base-docker-go-next/backend/internal/handler/http/api/v1/success"
